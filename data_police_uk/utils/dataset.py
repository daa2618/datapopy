    ...
    def _load_pdf(self):
        ...
        if self.doc_url:
            try:
                ...
                print(f"Error obtaining pdf from url\n\t{e}")
            ...
            try:
                ...
                print(f"Failed to load pdf from filepath\n\t{e}")
    ...
    def _load_geojson(self):
        ...
        if self.doc_url:
            ...
            try:
                ...
                print("Failed to load geojson from file\n\t{e}")
